            ...
            <div className="posts-div flex2">
              <div className="publish-post flex2">
                ...
                <div className="postinputs flex2">
                  <div className="flex2 gap5">
                    ...
                    />
                    <button className="gray-button" onClick={savePost}>
                      Post
                    </button>
                  </div>
              ...
              <div className="posts">
                ...
                <p className="post-caption">
                  Smart innovation in Taiwan - Gogoro technology electric
                  scooter battery swap solutions make urban sustainability
                  possible.
                </p>
